...
describe('Passing in strings to be evaluated', function () {
  var val = Validator()
  ...
  describe('Validating strings', function () {
    it('should basically accept most things', function () {
      ...
      assert.isTrue(
        val.validate(
          'string',
          "We aren't really concerned with limiting the length of strings because we assume people won't be idiots"
        )
      )
    })
