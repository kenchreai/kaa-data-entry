...
To promote other users to be admins, issue a POST request to the following url: `http://kaa-data-editor.herokuapp.com/api/admins/{{username}}` with your admin token in the request header `'x-access-token'`. 
